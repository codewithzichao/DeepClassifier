...
from deepclassifier.models import BertDPCNN
...
train_mask = np.random.randint(0, 1, (100, 60))
...
dev_mask = np.random.randint(0, 1, (100, 60))
...
test_mask= np.random.randint(0, 1, (100, 60))
...
my_model = BertDPCNN(768,0.2,2,"/Users/codewithzichao/Desktop/开源的库/DeepClassifier/bert-base-uncased/")
...
my_trainer = Trainer(model_name="bertdpcnn", model=my_model, train_loader=final_train_data, dev_loader=final_dev_data,
