...
from deepclassifier.models import BertRCNN
...
my_trainer = Trainer(model_name="bertrcnn", model=my_model, train_loader=final_train_data, dev_loader=final_dev_data,
