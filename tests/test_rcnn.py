...
from deepclassifier.models import RCNN
...
my_model = RCNN(100,100,0.2,2,100,60)
optimizer = optim.Adam(my_model.parameters())
loss_fn = nn.CrossEntropyLoss()
save_path = "best.ckpt"

writer = SummaryWriter("logfie/1")
my_trainer = Trainer(model_name="rcnn", model=my_model, train_loader=final_train_data, dev_loader=final_dev_data,
